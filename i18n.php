...
$lang = "ar";
$langf = "العربية";
$th = "أداة التحقق من أسماء المستخدمين";
$un = "اسم المستخدم";
$t0 = "<p>هذه الأداة تتحقق من وجود الاسم من قبل أو لا.</p>";
$t1 = "الأسماء بالإنجليزية يجب ان تبدأ بحروف كبيرة.";
$t2 = "<b>@</b> هذا الاسم غير مسموح به.";
$t3 = "اسم المستخدم طويل جدًا.";
$t4 = "يحتوي على حروف ممنوعة مثل (#, <, >, [, ], |, {, }, ...).";
$t5 = "الاسم المطلوب صالح للاستعمال (يظهر فحص تنسيق الاسم غير المقبول سلبيًا).";
$t6 = "الاسم مسجل سابقًا، يرجى اختيار اسم اخر.";
$t7 = "الاسم غير مسجل سابقًا.";
